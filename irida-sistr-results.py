...
def main(irida_url,client_id,client_secret,username,password,verbose,projects,tabular_file,excel_file,exclude_user_results,exclude_user_existing_results,all_projects,timeout,config):
...
if __name__ == '__main__':
	...
	parser.add_argument('-c', '--config', action='store', dest='config', help='Configuration file for IRIDA '+str(get_conf_files()))
