...
def main(irida_url,client_id,client_secret,username,password,verbose,projects,tabular_file,excel_file,exclude_user_results,exclude_user_existing_results,all_projects,timeout):
...
if __name__ == '__main__':
	...
	parser.add_argument('--to-tab-file', action='store', dest='tabular_file', help='Print results to tab-deliminited file.')
	parser.add_argument('-o', '--to-excel-file', action='store', dest='excel_file', help='Print results to the given excel file.')
